            ...
            <div class="card card-cascade narrower bg-dark pt-0">
              ...
              <div class="d-flex align-self-center mx-5">
                ...
                <div class="container country-name">
                  <h1 class="responsive-font" style="background-image: linear-gradient(blue, orange);"><div class="spinner-grow text-light mb-md-1 mb-lg-2 mb-xl-2.8" style="animation-duration: 2s;" role="status"></div>UNITED KINGDOM OF GREAT BRITAIN AND NORTHERN IRELAND AMBASSADORS<div class="spinner-grow text-light mb-md-1 mb-lg-2 mb-xl-2.8" style="animation-duration: 2s;" role="status"></div></h1>
                </div>
              </div>
              ...
              <div class="card bg-dark">
                ...
                <div class="view overlay text-center">
                  ...
                  <div class="text-white mt-5">
                      <div class="ambassador">H.E BARRANCO GUILLEN JUAN</div>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                ...
                <div class="view overlay text-center">
                  ...
                  <div class="text-white mt-5">
                    <div class="ambassador">H.E ROGERS BUCK</div>
